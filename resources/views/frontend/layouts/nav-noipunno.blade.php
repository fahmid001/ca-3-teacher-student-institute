                        ...
                        <ul class="navbar-nav d-flex justify-content-end ms-auto align-items-center">
                            {{-- <li class="nav-item">
                                <a class="nav-link" href="#"><img
                                        src="{{ asset('frontend/images/fav-start-icon.svg') }}" alt=""></a>
                            </li>
                            ...
                            <div class="accordion accordion-flush" id="report">
                                <div class="accordion-item">
                                    ...
                                    <div id="report-collapseOne" class="accordion-collapse collapse" aria-labelledby="report-headingOne" data-bs-parent="#report">
                                        <div class="accordion-body d-flex flex-column py-0 px-0 pages-buttons">
                                            <a href="#" class="d-block "><button class="w-100 btn btn-light px-5 text-start">শিক্ষার্থীদের
                                                    মূল্যায়ন</button>
                                            </a>
                                            <a href="#" class="d-block "><button class="w-100 btn btn-light px-5 text-start">শিক্ষার্থীর
                                                    ট্রান্সক্রিপ্ট</button>
                                            </a>
                                            <a href="#" class="d-block "><button class="w-100 btn btn-light px-5 text-start">শ্রেণির
                                                    প্রতিবেদন</button>
                                            </a>
                                            <a href="#" class="d-block "><button class="w-100 btn btn-light px-5 text-start">শিক্ষার্থীর হাজিরা
                                                    প্রতিবেদন</button>
                                            </a>
