        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h4 class="title mt-5">সেকশন ভিত্তিক বিষয় শিক্ষকের তথ্য যুক্ত করুন</h4>
                                ...
                                <div class="row">
                                            ...
                                            <div class="input-group">
                                                <select class="form-select np-teacher-input" name="branch_id" id="branch_id"
                                                    ...
                                                    @foreach ($branches as $item)
                                                        <option value="{{ $item->uid }}">{{ $item->branch_name }}
                                                        </option>
                                                    @endforeach
                                        ...
                                        <div>
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control np-teacher-input"
                                                    name="session_year" id="session_year" readonly>
                                    ...
                                    <div class="col-md-4 col-sm-12 mt-3">
                                        <div>
                                            ...
                                            <div class="input-group">
                                                {{-- @dd($teachers) --}}
                                                <select class="form-select np-teacher-input select2" name="class_teacher_id"
                                                    aria-label="Default select example">
                                                ...
                                                <option value="3">Teacher Three</option> --}}
                                                    ...
                                                    @foreach ($teachers as $item)
                                                        <option value="{{ $item->uid }}">{{ $item->name_en}} - {{ @$item->pdsid ?? @$item->index_number ?? @$item->caid }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 d-flex justify-content-start">
                                                <button type="submit"
                                                    ...
                                                    style="width: fit-content;border: unset;column-gap: 10px;">তথ্য সংরক্ষন
                                                    করুন <img
                    ...
                    if (data.sections) {
                        $.each(data.sections, function(index, category) {
                            $('#section_id').append('<option value ="' + category
                                .uid + '"' + ((category.uid == selected) ? ('selected') : '') + '>' + category.section_name +
                                '</option>');
                        });
