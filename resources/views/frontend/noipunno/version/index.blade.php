...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <h2 class="np-form-title mt-5">ভার্সন যোগ করুন</h2>
                        ...
                        <div class="row">
                            <!-- <div class="col-md-4 col-sm-12">
                                    <div>
                                        ...
                                        <input type="number" class="form-control np-teacher-input" id="loginId" placeholder="123" name="version_id">
                                    </div>
                                </div> -->
                                    ...
                                    <div>
                                        <div class="input-group">
                                            <select class="form-select np-teacher-input" aria-label="Default select example" name="version_name">
                                                ...
                                                <option value="বাংলা" {{ old('version_name','') == "বাংলা" ? 'selected':'' }}>বাংলা ভার্সন</option>
                                                <option value="ইংলিশ" {{ old('version_name','') == "ইংলিশ" ? 'selected':'' }}>ইংলিশ ভার্সন</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="input-group">
                                        <select class="form-select np-teacher-input" name="branch_id" id="branch_id" aria-label="Default select example">
                                            ...
                                            <option value="{{$branch->uid}}" {{ old('branch_id','') == @$branch->uid ? 'selected':'' }}>{{$branch->branch_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
