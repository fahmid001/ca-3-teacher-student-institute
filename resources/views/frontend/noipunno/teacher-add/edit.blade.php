    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <h2 class="title">শিক্ষকের তালিকা</h2>
                            </div>
                                            ...
                                            <table class="table np-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td scope="row">{{@$teacher->pdsid ?? $teacher->caid}}</th>
                ...
                <div class="np-teacher-list row mt-5">
                    <div class="col-md-6"> <h2 class="title">শিক্ষকের তথ্য পরিবর্তন</h2></div>
                    <div class="col-md-6">
                                ...
                                <div class="row">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <select   class="form-select np-teacher-input" aria-label="Default select example"  name="designation" id="teacherDesignation">
                                                    ...
                                                    <option value="{{ $designation->uid }}" @if(@$myteacher->designation == $designation->uid) selected @endif>{{ $designation->designation_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <select disabled  class="form-select np-teacher-input" aria-label="Default select example" readonly name="division_id" id="division_id">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <select disabled  class="form-select np-teacher-input" aria-label="Default select example" readonly name="district_id" id="district_id">
                                                    <option value="">জেলা নির্বাচন করুন</option>
                                                    @foreach ($districts as $district)
                                                    <option class="district-option division-{{$district->division_id}}" value="{{ $district->district_id }}" @if(@$myteacher->district_id == $district->district_id) selected @endif>{{ $district->district_name_bn ?? $district->district_name_en }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <select disabled  class="form-select np-teacher-input" aria-label="Default select example" readonly name="upazila_id" id="upazila_id">
            ...
            <div class="col-md-4">
                <div class="container">
                    <div class="np-profile-card-header mt-5">
